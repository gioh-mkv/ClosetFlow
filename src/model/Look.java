...
public class Look {
    ...
    // Sobrecarga para modificar look baseado no tipo de peça
    ...
    public void registrarUtilizacao(LocalDate data, String periodo, String ocasiao) {
        UtilizacaoLook utilizacao = new UtilizacaoLook(data, periodo, ocasiao);
        utilizacoes.add(utilizacao);
        
        // Registrar utilização em cada item do look
